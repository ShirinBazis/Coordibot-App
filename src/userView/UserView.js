...
const defaultEvents = [{
  ...
  id: 2,
  start: '2023-05-22T15:00',
  end: '2023-05-22T16:00',
  ...
  id: 3,
  start: '2023-05-21T18:00',
  end: '2023-05-21T22:00',
  title: 'Dexter BD',
  description: '',
  allDay: false,
  free: true,
  ...
  id: 4,
  start: '2023-05-23T10:30',
  end: '2023-05-23T11:30',
...
export default function UserView({ currentUser }) {
  ...
  const [popupEventCreator, setCreator] = React.useState('');
  const [popupEventInvited, setInvited] = React.useState('');
  ...
  const saveEvent = React.useCallback(() => {
    const newEvent = {
      ...
      creator: popupEventCreator,
      invited: popupEventInvited,
    ...
    popupEventCreator, popupEventInvited, popupEventLocation, popupEventStatus, popupEventTitle, tempEvent, selectedColor]);
  ...
  const creatorChange = React.useCallback((ev) => {
    setCreator(ev.target.value);
  }, []);

  const invitedChange = React.useCallback((ev) => {
    setInvited(ev.target.value);
  }, []);
  ...
  return <div>
    ...
    >
      <div className="mbsc-form-group">
        ...
        <Textarea label="Creator" value={popupEventCreator} onChange={creatorChange} />
        <Textarea label="Invited" value={popupEventInvited} onChange={invitedChange} />
        <Textarea label="Location" value={popupEventLocation} onChange={locationChange} />
      </div>
      <div className="mbsc-form-group">
